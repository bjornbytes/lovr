...
StringEntry lovrDeviceButton[] = {
  ...
  [BUTTON_THUMBSTICK_UP] = ENTRY("thumbstick/up"),
  [BUTTON_THUMBSTICK_DOWN] = ENTRY("thumbstick/down"),
  [BUTTON_THUMBSTICK_LEFT] = ENTRY("thumbstick/left"),
  [BUTTON_THUMBSTICK_RIGHT] = ENTRY("thumbstick/right"),
  [BUTTON_THUMBREST] = ENTRY("thumbrest"),
  [BUTTON_TOUCHPAD] = ENTRY("touchpad"),
  [BUTTON_TOUCHPAD_UP] = ENTRY("touchpad/up"),
  [BUTTON_TOUCHPAD_DOWN] = ENTRY("touchpad/down"),
  [BUTTON_TOUCHPAD_LEFT] = ENTRY("touchpad/left"),
  [BUTTON_TOUCHPAD_RIGHT] = ENTRY("touchpad/right"),
  [BUTTON_TOUCHPAD_CENTER] = ENTRY("touchpad/center"),
  ...
  [BUTTON_X] = ENTRY("x"),
  [BUTTON_Y] = ENTRY("y"),
  [BUTTON_DPAD_UP] = ENTRY("dpad/up"),
  [BUTTON_DPAD_DOWN] = ENTRY("dpad/down"),
  [BUTTON_DPAD_LEFT] = ENTRY("dpad/left"),
  [BUTTON_DPAD_RIGHT] = ENTRY("dpad/right"),
