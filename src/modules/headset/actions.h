enum {
  ...
  ACTION_SHOULDER_DOWN,
  ACTION_SHOULDER_TOUCH,
  ACTION_NIB_DOWN,
  ACTION_NIB_FORCE,
  ACTION_HAND_VIBRATE,
...
static Binding* lovrActionBindings[] = {
  ...
  [PROFILE_COSMOS] = (Binding[]) {
    ...
    { ACTION_X_DOWN, "/user/hand/left/input/x/click" },
    { ACTION_Y_DOWN, "/user/hand/left/input/y/click" },
    { ACTION_SHOULDER_DOWN, "/user/hand/left/input/shoulder/click" },
    { ACTION_SHOULDER_DOWN, "/user/hand/right/input/shoulder/click" },
    { ACTION_HAND_VIBRATE, "/user/hand/left/output/haptic" },
    { ACTION_HAND_VIBRATE, "/user/hand/right/output/haptic" },
    { 0, NULL }
  },
  ...
  [PROFILE_FRAME] = (Binding[]) {
    ...
    { ACTION_SHOULDER_DOWN, "/user/hand/left/input/shoulder/click" },
    { ACTION_SHOULDER_DOWN, "/user/hand/right/input/shoulder/click" },
    { ACTION_SHOULDER_TOUCH, "/user/hand/left/input/shoulder/touch" },
    { ACTION_SHOULDER_TOUCH, "/user/hand/right/input/shoulder/touch" },
    { ACTION_HAND_VIBRATE, "/user/hand/left/output/haptic" },
    { ACTION_HAND_VIBRATE, "/user/hand/right/output/haptic" },
    { 0, NULL }
  }
