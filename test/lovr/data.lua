group('data', function()
  group('Blob', function()
    ...
    test(':set* byte range', function()
      ...
      expect(function() blob:setData(blob, 0, 1) end).to.fail()
      expect(function() blob:setData(blob, 1, 0) end).to.fail()
      expect(function() blob:setData(blob, 0, -10) end).to.fail()
      expect(function() blob:setData(blob, -10, 0) end).to.fail()
      expect(function() blob:setData(blob, 0, 0, 2) end).to.fail()
      expect(function() blob:setData(blob, 0, 0, -1) end).to.fail()
    end)
    ...
    test(':setData', function()
      ...
      blob:setData(blob, 2, 0)
      expect(blob:getU16(0, 4)).to.equal(1, 1, 2, 3)
    end)
    ...
    test(':clear', function()
      ...
      blob:setU16(0, 0, 1, 60000)
      blob:clear()
      expect(blob:getU16(0, 3)).to.equal(0, 0, 0)
    end)
